...
<body style="background-image: url('<%=basePath%>static/images/bg.jpg');">
	...
	<div class="modal fade" id="tableModal" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" style="width:1000px;margin-top:10%;">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="modal fade" id="timeAxisModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" style="width:90%;margin-top:10%;">
			<div class="modal-content">
				...
				<div class="modal-body" style="height: 55%;margin-top: 25px;">
					<div class="container">
						<div class="fishBone" />
					</div>
				</div>
    ...
    $(function(){
    	...
    	$("body").delegate(".next1","click",function(){
    		...
    		console.log("当前next到右边的距离：" + (parseInt(left) - 680));
    		var count = parseInt(left) - 680;
    		var mapCount = 1500 - count;
    	    var weight = echarts.init(document.getElementById('weight'));
    	    //对临界值进行处理
    	    if (_data.length == 6) {
    	    	mapCount = count;
    	    }
    		if (mapCount >= 400 && count > 0 ) {
    			console.log("可以画图");
    			//开始进行统计图的绘制
    	        huatu(weight);
    			//开始隐藏fixNext
    		        			    ...
    		        			    series : [
    		        			        {
    		        			            ...
    		        			            data:[
    		        			                {value:335, name:'医保基金支付'},
    		        			                {value:310, name:'个人账户支付'},
    		        			                {value:234, name:'公务员补助'},
    		        			                {value:135, name:'大病统筹支付'},
    		        			                {value:1548, name:'其他'}
    		        			            ],
    		        			            itemStyle: {
    		        			                emphasis: {
