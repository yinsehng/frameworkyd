$.fn.fishBone = function(data) {
    ...
    function creataFishBone(data) {
        ...
        $(data).each(function(index) {
          ...
          //封装审理时间和案号
            ...
            if (index == (data.length - 1)) {
            	if(itemclass=="bottom"){
            		var next = $("<a class='next' style='top:-20px!important;right:20!important'></a>");
            	}
            	if(itemclass=="top"){
            		var next = $("<a class='next' style='top:164px!important;right:20!important'></a>");
            	}
            	ul.append(next);
            }
            li_item.append(line);
        ...
        //在最后添加一个饼形图的统计占比
        var weight = $("<div id='weight'style='width: 500px;height:90%;margin-top: -409px;margin-left: 66%;z-index:1;'></div>");
        fishBone.append(wrapper).append(prev).append(weight);
        return fishBone;
    };
    /**item添加样式，显示在上方或下方*/
